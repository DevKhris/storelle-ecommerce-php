<nav class="navbar navbar-expand-sm navbar-dark bg-black text-light">
  ...
  <ul class="navbar-nav ml-auto pr-3 mb-2 mb-lg-0">
    <li class="nav-item">
      <a class="nav-link" href="?p=profile&b">Balance: 100$</a>
    </li>
    <li class="nav-item">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      ...
      <ul class="navbar-nav mr-auto font-weight-bold">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="?p=about">About Us</a>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav ml-auto d-flex">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDarkDropdownMenuLink">
            <li><h6 class="dropdown-header text-muted">Shopping Cart</h6></li>
            <li class="nav-item">
              <div class="card">
