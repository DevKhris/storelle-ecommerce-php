...
if ($_SESSION['auth'] === false) {
    ...
    $app->router->post('/login', [DashboardController::class, 'login']);
    $app->router->get('/register', [DashboardController::class, 'index']);
    $app->router->post('/register', [DashboardController::class, 'register']);
    ...
    $app->router->post('/logout', [DashboardController::class, 'logout']);
}
